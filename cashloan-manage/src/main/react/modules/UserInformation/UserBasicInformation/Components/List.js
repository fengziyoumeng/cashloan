...
export default React.createClass({
  ...
  hideModal() {
    ...
    console.log(record)
        ...
        this.refs.UpView.setFieldsValue(record);
    },
  //新增跟编辑弹窗
  ...
  render() {
    ...
    //       <a href="javascript:;" onClick={me.UpView.bind(me, '编辑', record, true)}>编辑</a>
    //           <span className="ant-divider"></span>
    //       {record.state == "10" ? (
    ...
    return (
      ...
      <UpView ref="UpView" visible={state.visibleUp} hideModal={me.hideModal} record={state.record}/>
      </div>
    );
  }
})