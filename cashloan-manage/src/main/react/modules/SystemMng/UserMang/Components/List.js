  ...
  render() {
    ...
    var columns = [{
      ...
      render(text, record) {
        ...
        <a href="#" onClick={me.changeStatus.bind(me,'重置密码',record,true)}>重置密码 </a>
        <span className="ant-divider"></span>
        {record.status == '1' ?<a href="#" onClick={me.changeStatus.bind(me,'解锁',record,true)}>解锁 </a>
        :<a href="#" onClick={me.changeStatus.bind(me,'锁定',record,true)}>锁定 </a>}
        </div>
      }
    }];
