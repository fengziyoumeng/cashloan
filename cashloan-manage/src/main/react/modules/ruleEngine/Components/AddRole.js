...
var AddRole = React.createClass({
 ...
 //   //console.log("state.keys2",state.keys2);
    ...
    const formItems = state.keys.map((k) => {
      ...
      const formItemsForTongGuo = state.keys.map((k) => {
          return (<div key={k}>
            <Input type='hidden' {...getFieldProps(`${k}id`,{initialValue:this.formData?this.formData[`${k}id`]:0})}/>
            <Row>
              <Col span="8" className='col_h'>
              ...
              <Col span="3" className="col_h">
                <FormItem  {...{ labelCol: {},wrapperCol: {span:20}} }
                           label="">
                  <Select style={{ width: '100%' }} placeholder="请选择"  {...getFieldProps(`${k}result`,{initialValue:'30'})} disabled={true}>
                      {/*<Option  value="">结果选择</Option>*/}
                    <Option  value={"30"}>通过</Option>
                  </Select>
                </FormItem>
  ...
  {/*-----------------------------------------------------------------------------------------------------------------------------------------*/}
         ...
         {this.state.itemOne?( <Row>
           ...
           {this.state.type=='10'?(
               ...
               this.state.type=='20'?<Col span="3" className="col_h">
                 <FormItem  {...{ labelCol: {},wrapperCol: {span:20}} }
                            label="">
               ...
               <Col span="3" className="col_h">
                 <FormItem  {...{ labelCol: {},wrapperCol: {span:20}} }
                            label="">
                   <Select style={{ width: '100%' }}  placeholder="请选择" {...getFieldProps("0result",{initialValue:'30'})} disabled={true}>
                       {/*<Option  value="">结果选择</Option>*/}
                     <Option  value={"30"}>通过</Option>
                   </Select>
                 </FormItem>
           ...
           {/* {this.state.keys2.length? formItem2 : null}*/} 
             { this.state.keys.length ? ( this.state.type =="30"?formItemsForTongGuo:formItems): null}
          </Form>
      </Modal>
    );
  }
