                ...
                <Row>
                    ...
                    <Col span="8" className='col_h'>
                        <FormItem  {...{
                            ...
                            <InputNumber  style={{ width:'86px'}}  {...getFieldProps(`${k}ruleSort`,{initialValue:'0'}) } type="number" />
                        </FormItem>
                    </Col>
                    <Col span="2">
                            ...
                            <FormItem  {...{ labelCol: { span: 8 }, wrapperCol: { span: 16 } }}
                                label="规则适用场景:">
                                {
                                    ...
                                    <Select style={{ width: '200px' }} {...getFieldProps('adaptedId', { rules: [{ required: true, message: '必选' }] }) }>
                                        ...
                                        <Option key={"11"}>个人信息</Option>
                                        <Option key={"12"}>运营商</Option>
                                        {/*<Option key={"13"}>紧急联系人</Option>*/}
                                        <Option key={"14"}>芝麻信用</Option>
                                        <Option key={"15"}>同盾</Option>
                                    </Select>
                                }
                            </FormItem>
                        </Col>
