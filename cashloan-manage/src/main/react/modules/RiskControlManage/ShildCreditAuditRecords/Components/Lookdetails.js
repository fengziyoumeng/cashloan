         ...
         <Row>
            <Col span="12">
              <FormItem  {...formItemLayouttwo} label="借款订单号:">
                {state.record.borrowOrderNo}
              </FormItem>
            </Col>
            <Col span="12">
              <FormItem  {...formItemLayouttwo} label="借款金额:">
                {state.record.borrowAmount}
              </FormItem>
            </Col>
          </Row>
         <Row>
          ...
          <Row>
            <Col span="12">
              {/*<FormItem  {...formItemLayouttwo} label="提交审核返回信息:">*/}
                <FormItem  {...formItemLayouttwo} label="审核返回信息:">
         ...
         {/*<Row>*/}
            {/*<Col span="12">*/}
              {/*<FormItem  {...formItemLayouttwo} label="查询审核报告信息:" >*/}
                ...
                {/*<div style={{width:'600px',wordWrap:'break-word',wordBreak:'break-all' }}>{props.detail? (state.show ? props.detail.queryParams :props.detail.queryParams.substring(0,250)+'...') :""}</div>*/}
              {/*</FormItem>*/}
            {/*</Col>*/}
         {/*</Row>*/}
        </Form>
