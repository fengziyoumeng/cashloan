...
export default React.createClass({
    ...
    fetch(params = {}) {
        ...
        Utils.ajaxData({
            url: '/act/flowControl/getAllForUV.htm',
            method: "post",
            data: params,
            callback: (result) => {
                console.info("=======>"+result);
    ...
    render() {
        ...
        var columns = [
            ...
            dataIndex: 'pname'
                ...
                title: '今日UV数(非时时)',
                dataIndex: 'ptodayClickCount'
        },  {
                title: '当月UV数(非时时)',
                dataIndex: 'pPreMonthClickCount'
        },{
                title: '上月UV数',
                dataIndex: 'pPreMonthClickCount1'
        }, {
            title: 'UV总数(非时时)',
            dataIndex: 'phistoryTotalClickCount'
        },  {
            title: '更新时间',
