        ...
        onOk: function () {
          Utils.ajaxData({
            ...
            data: {
              ...
              amount: me.state.value == 10 ? me.props.record.repayAmount : values.amount,
              penaltyAmout: me.state.value == 10 ? me.props.record.penaltyAmout : values.penaltyAmout1,
            ...
            <Col span="24">
              <FormItem {...formItemLayout} label="还款选择:">
                <RadioGroup onChange={this.onChange1} value={this.state.value}>
                  <Radio key="a" value={10}>正常还款</Radio>
                  <Radio key="b" value={20}>金额减免</Radio>
                  <Radio key="c" value={30}>逾期正常还款</Radio>
                </RadioGroup>
              </FormItem>
            </Col>
          </Row>
