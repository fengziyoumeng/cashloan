...
//            }
    ...
    public boolean upload(String localDirectoryAndFileName, String ftpFileName, String ftpDirectory) {
        ...
        if (ftpClient != null) {
            ...
            try {
                ...
                // 创建目录
                boolean mkDirFlag = this.mkDir(ftpDirectory);
                logger.info("***********创建目录mkDirFlag："+mkDirFlag+"***************");
    ...
    public static void main(String[] args) {
        FtpUtils f = new FtpUtils("192.168.126.132", 21, "test", "123456");
        try {
            if(f.open()) {
                String fileName = "911.txt";

//                PrintWriter pw=new PrintWriter("1001.txt");
//                pw.print("sadasjkdasdjkhasjdkhas999");
//                pw.close();
                //上传
                f.upload("1001.txt", fileName, "test1/aaa");
...
//                f.getFtpClient().
//                PrintWriter pw = new PrintWriter(f.getFtpClient());
