...
<body>
    <div class="chatBox">
        ...
        <!-- m.51jjhao.com -->
        <div class="c_info">
            服务器地址：<input type="text" id="addr" class="inputText" value="m.51jjhao.com://chat" readonly="true">
            用户名：<input type="text" id="userName" class="inputText" value="" placeholder="请输入用户名...">
