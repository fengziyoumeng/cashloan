  ...
  <body>
    ...
    <ul>
      ...
      <li>邮政储蓄银行卡不支持自动扣款，怎么办？
        <p>可通过支付宝进行还款。支付宝账号：<span class='airPay'>hzmh@yongqianbei.com</span> ，还款后请与客服取得联系，将注册用户手机号、转账金额和转入银行卡信息截图提供给客服。客服电话：<span class='phone'>0571-88003589</span>（工作日9:00-18:00）</p>
      </li>
    </ul>
    <h3>支付宝转账</h3>
    <ul>
      <li>如何进行支付宝转账？
        <p>进入支付宝首页，点击“转账”，选择“转到支付宝账户”，输入支付宝账号：<span class='airPay'>hzmh@yongqianbei.com</span> ,点击“下一步”，输入转账金额，并将姓名和注册手机号添加到备注中，点击“确认转账”，输入支付宝密码即可完成还款。</p>
      </li>
      <li>如何确认支付宝转账是否成功？
        <p>还款后请及时在“借款详情”页查看还款状态，当页面默认显示为申请页面时，则表示还款成功。如有疑问请联系客服。客服电话：<span calss='phone'>0571-88003589</span>（工作日9:00-18:00）</p>
      </li>
    </ul>
  </div>
