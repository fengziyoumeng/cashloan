...
//    }
    ...
    public String strDec(String data, String firstKey, String secondKey,
                         String thirdKey) {
        int leng = data.length();
        System.out.println("data:"+data+"::"+leng);
        String decStr = "";
        List firstKeyBt = null, secondKeyBt = null, thirdKeyBt = null;
        int firstLength = 0, secondLength = 0, thirdLength = 0;
        if (firstKey != null && firstKey != "") {
    ...
    public static void main(String[] args) {
        ...
        String data = "wang";
        String str = desObj.strEnc(data, key1, key2, key3);
        System.out.println("des加密："+str);
        String ss =  Base64.encode(new String(str).getBytes());
        System.out.print("base64加密："+ss);

        String dec = desObj.strDec(str, key1, key2, key3);
        System.out.println("des解密："+dec);
        byte[] ss2 =  Base64.decode(ss);
        System.out.print("base64解密："+new String(ss2));

        String pwd="NjFDODI0NkZFRDU3MDcyMQ==";
        byte[] ss3 =  Base64.decode(pwd);
        System.out.print("base64解密："+new String(ss2));
        String dec3 = desObj.strDec(new String(ss3), key1, key2, key3);
...
//        String secretKey = "pasec23der1e12ecjer3AFRGYD03847@@*^DEJUsdu33";
////       // String secretKey = UUID.randomUUID().toString().replaceAll("-", "") ;
//        System.out.println("uuid="+secretKey);
//        System. out.println( "----加密前-----：" + str );
//        String encodeStr = Des3Util. strEnc( str,secretKey);
//        System. out.println( "----加密后-----：" + encodeStr );
//        System. out.println( "----解密后-----：" + Des3Util.decode( encodeStr,secretKey));
//
//        String ss = "prepay_id=wx20161230203216e15d4e5f2f0103554968";
